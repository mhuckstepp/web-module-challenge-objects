...
function createMenuItem(nameVal, priceVal, catVal) {
  let newObj = { name: nameVal, price: priceVal, category: catVal };
  return newObj;
}
...
console.log(createMenuItem("Cheese", 99, "snacks"));
console.log(createMenuItem("Bread", 69, "Breakfast"));
console.log(createMenuItem("Water", 0, "free"));
...
reviews.push({ name: "john", rating: 10, feedback: "amazing burgers" });
console.log(reviews);
